...
$Tables["articles"]["schema"] = "
  ...
  INDEX date(date)
";
$Tables["articles"]["options"] = "ENGINE=InnoDB";
...
";
$Tables["articles_categories"]["options"] = "ENGINE=InnoDB";
...
";
$Tables["articles_comments"]["options"] = "ENGINE=InnoDB";
...
$Tables["articles_notifications"]["schema"] = "
  ...
  INDEX blog_id (blog_id)
";
$Tables["articles_notifications"]["options"] = "ENGINE=InnoDB";
...
";
$Tables["blogs"]["options"] = "ENGINE=InnoDB";
...
";
$Tables["mylinks"]["options"] = "ENGINE=InnoDB";
...
$Tables["mylinks_categories"]["schema"] = "
  ...
  INDEX blog_id (blog_id)
";
$Tables["mylinks_categories"]["options"] = "ENGINE=InnoDB";
...
";
$Tables["permissions"]["options"] = "ENGINE=InnoDB";
...
";
$Tables["referers"]["options"] = "ENGINE=InnoDB";
...
$Tables["users"]["schema"] = "
  ...
  UNIQUE user (user)
";
$Tables["users"]["options"] = "ENGINE=InnoDB";
...
";
$Tables["users_permissions"]["options"] = "ENGINE=InnoDB";
...
";
$Tables["config"]["options"] = "ENGINE=InnoDB";
...
$Tables["filtered_content"]["schema"] = "
   ...
   INDEX blog_id (blog_id)
";
$Tables["filtered_content"]["options"] = "ENGINE=InnoDB";
...
";
$Tables["host_blocking_rules"]["options"] = "ENGINE=InnoDB";
...
";
$Tables["gallery_resources"]["options"] = "ENGINE=InnoDB";
...
";
$Tables["gallery_albums"]["options"] = "ENGINE=InnoDB";
...
$Tables["bayesian_filter_info"]["schema"] = "
   ...
   INDEX blog_id (blog_id)
";
$Tables["bayesian_filter_info"]["options"] = "ENGINE=InnoDB";
...
$Tables["custom_fields_definition"]["schema"] = "
   ...
   INDEX blog_id (blog_id)
";
$Tables["custom_fields_definition"]["options"] = "ENGINE=InnoDB";
...
$Tables["custom_fields_values"]["schema"] = "
   ...
   INDEX blog_id_article_id (blog_id, article_id)
";
$Tables["custom_fields_values"]["options"] = "ENGINE=InnoDB";
...
$Tables["articles_text"]["schema"] = "
   ...
   FULLTEXT normalized_fields (normalized_text, normalized_topic)
";
$Tables["articles_text"]["options"] = "ENGINE=InnoDB";
...
";
$Tables["phpbb2_users"]["options"] = "ENGINE=InnoDB";
...
$Tables["blog_categories"]["schema"] = "
   ...
   INDEX mangled_name(mangled_name)
";
$Tables["blog_categories"]["options"] = "ENGINE=InnoDB";
...
$Tables["global_articles_categories"]["schema"] = "
   ...
   INDEX mangled_name(mangled_name)
";
$Tables["global_articles_categories"]["options"] = "ENGINE=InnoDB";
