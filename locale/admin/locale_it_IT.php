...
$messages['help_allow_javascript_blocks_in_posts'] = 'Permetti il blocco di codice Javascript negli articoli tramite i tag &lt;script&gt;. Nota che potrebbe porre un rischio della sicurezza ai tuoi blog [ Predefinito = No ]';
